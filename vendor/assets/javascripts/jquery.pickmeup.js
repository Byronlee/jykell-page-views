...
(function (factory) {
    ...
    tpl   = {
      ...
      head  : function (d) {
        ...
        return '<div class="pmu-instance">' +
          ...
          '</navigation>' +
          '<navigation class="pmu-day-of-week">' + result + '</navigation>' +
        '</div>';
      },
  ...
  function fill () {
    ...
    /**
     * Remove old content except header navigationigation
     */
    pickmeup.find('.pmu-instance > :not(navigation)').remove();
    /**
